...
-- Dumping structure for table test.beer
...
-- Dumping data for table test.beer: ~10 rows (approximately)
...
-- Dumping structure for table test.beertag
...
-- Dumping data for table test.beertag: ~0 rows (approximately)
/*!40000 ALTER TABLE `beertag` DISABLE KEYS */;
/*!40000 ALTER TABLE `beertag` ENABLE KEYS */;

-- Dumping structure for table test.brewery
...
-- Dumping data for table test.brewery: ~9 rows (approximately)
...
-- Dumping data for table test.country: ~5 rows (approximately)
...
-- Dumping structure for table test.drank_beer
...
-- Dumping data for table test.drank_beer: ~0 rows (approximately)
/*!40000 ALTER TABLE `drank_beer` DISABLE KEYS */;
/*!40000 ALTER TABLE `drank_beer` ENABLE KEYS */;

-- Dumping structure for table test.rating
...
-- Dumping data for table test.rating: ~0 rows (approximately)
/*!40000 ALTER TABLE `rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `rating` ENABLE KEYS */;

-- Dumping structure for table test.style
...
-- Dumping data for table test.style: ~9 rows (approximately)
...
-- Dumping structure for table test.tag
CREATE TABLE IF NOT EXISTS `tag` (
  `tag_id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table test.tag: ~0 rows (approximately)
...
-- Dumping structure for table test.wish_beer
...
-- Dumping data for table test.wish_beer: ~0 rows (approximately)
