...
INSERT INTO `beer` (`beer_id`, `beer_picture`, `description`, `name`, `abv`, `beer_country_fk`, `beer_brewery_fk`, `beer_style_fk`, `avg_rating`, `created_by`) VALUES
...
-- Dumping data for table beer.role: ~0 rows (approximately)
...
INSERT INTO `user` (`user_id`, `first_name`, `last_name`, `nickname`, `email`, `picture`, `deleted`, `password`) VALUES
	...
	(7, 'Allaha', 'aaaaaaaaa', 'aaaaaaa', 'aaaaaaaa', NULL, 0, 'hgjhfjfh');
...
-- Dumping data for table beer.user_role: ~0 rows (approximately)
