...
REPLACE INTO `beer` (`beer_id`, `beer_picture`, `description`, `name`, `abv`, `beer_country_fk`, `beer_brewery_fk`, `beer_style_fk`, `avg_rating`, `created_by`) VALUES
	...
	(8, 'Test', 'Caramel stout aged for almost 6 months in oak barrels previously containing Arkanj brandy (Calvados) made by the Kovilj Monastery. ', '02 Kolaboracija Caramel Stout', 10, 2, 6, 6, 0, 4),
	(9, 'Test', 'Milk Stout, smooth, full mouth feel. Strong body with distinctive flavours of coffee, cocoa, vanilla and tropical notes in the back, a real treat for the connoisseurs. Not for lactose intolerant.', 'Mikkeller Vista Milk Stout', 5.8, 2, 2, 8, 0, 2),
...
REPLACE INTO `beertag` (`beertag_id`, `beer_beer_id`, `tag_tag_id`) VALUES
	(8, 1, 3),
	(9, 5, 6),
	(10, 8, 2),
	(11, 5, 5),
...
REPLACE INTO `brewery` (`name`, `brewery_id`) VALUES
	('Bierol', 7),
...
REPLACE INTO `country` (`name`, `country_id`) VALUES
	('Austria', 4),
	('Belgium', 5),
	('Bulgaria', 1),
	('Germany', 3),
...
CREATE TABLE IF NOT EXISTS `drank_beer` (
  ...
  `drank_beer_user_id` int(11) NOT NULL,
  `drank_beer_beer_id` int(11) NOT NULL,
...
-- Dumping data for table beer.drank_beer: ~10 rows (approximately)
/*!40000 ALTER TABLE `drank_beer` DISABLE KEYS */;
REPLACE INTO `drank_beer` (`drank_beer_id`, `drank_beer_user_id`, `drank_beer_beer_id`, `deleted`) VALUES
	(1, 1, 1, b'0'),
	(2, 2, 1, b'0'),
	(3, 4, 1, b'0'),
	(4, 5, 2, b'0'),
...
REPLACE INTO `rating` (`rating_id`, `rating`, `drank_id`) VALUES
	(4, 6, 7),
	(5, 5, 6),
	(6, 8, 2),
	(7, 6, 1),
...
-- Dumping data for table beer.role: ~2 rows (approximately)
...
REPLACE INTO `style` (`name`, `style_id`) VALUES
...
REPLACE INTO `tag` (`tag_id`, `name`) VALUES
	(1, 'Coffee'),
	(2, 'Caramel'),
	(3, 'Light'),
	(4, 'Dark'),
...
-- Dumping data for table beer.user: ~7 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
REPLACE INTO `user` (`user_id`, `first_name`, `last_name`, `nickname`, `email`, `picture`, `deleted`, `password`) VALUES
	(1, 'Petar', 'Petrov', 'p3sho_93', 'pesho@gmail.com', NULL, 0, 'sdfgfdg'),
	(2, 'Jonh', '', 'Jony_123', 'Jony@gmail.com', NULL, 0, 'dafgfdgdafg'),
	(3, '', '', 'beer_master', 'master_beer@yahoo.com', NULL, 0, 'gaafgg'),
	(4, 'Maria', 'Spasova', 'Maria_db', 'marcheto@gmail.com', NULL, 0, 'rgafgagfb'),
	(5, '', 'Petrov', 'noFear', 'igracha@gmail.com', NULL, 0, 'afdhhtr'),
	(6, 'Allah', 'Mehmedov', 'bai_mangal_jelezoto', 'ciganina_bate@gmail.com', NULL, 0, 'qrtrtreg'),
	(7, 'Yordan', 'Lechkov', 'djony_boy', 'dancho@abv.bg', NULL, 0, 'hgjhfjfh'),
	(8, 'empty', 'empty', 'p3sho', 'dai_mu@abv.bg', NULL, 0, 'ebasi'),
	(9, 'empty', 'empty', 'p3asho', 'dai_mua@abv.bg', NULL, 0, 'ebasi'),
	(10, '', '', 'pa3asho', 'dai_maua@abv.bg', NULL, 0, 'ebasi'),
	(11, '', '', 'paa3asho', 'dai_maaua@abv.bg', NULL, 0, 'ebasi'),
	(12, 'aba', 'ada', 'paa3aasho', 'dai_maaaua@abv.bg', NULL, 0, 'ebasi');
...
-- Dumping data for table beer.user_role: ~16 rows (approximately)
...
-- Dumping data for table beer.wish_beer: ~7 rows (approximately)
/*!40000 ALTER TABLE `wish_beer` DISABLE KEYS */;
REPLACE INTO `wish_beer` (`beer_user_id`, `user_user_id`, `beer_beer_id`, `deleted`) VALUES
	(1, 1, 1, b'0'),
	(2, 2, 1, b'0'),
	(3, 3, 1, b'0'),
	(4, 1, 2, b'0'),
